      ...
      <div className='flex flex-col gap-12'>
        <div>
          ...
          <p className="text-base font-normal mt-10 lg:text-left text-center max-lg:px-8">
            ...
            <NavLink to='/dashboard' className='underline text-blue-400'> Únete ahora con nosotros</NavLink> y empieza a lograr tú mejor version.
          </p>
        </div>

        <div className='flex flex-row gap-8 items-center max-lg:justify-center max-lg:my-12'>
          <NavLink className='hover:opacity-80 transition-all px-5 py-2 text-white rounded-sm bg-indigo-600' to='/payments'>Unete ahora</NavLink>
          <NavLink className='hover:opacity-80 transition-all px-5 py-2 text-white bg-black border border-white rounded-sm' to='/services'>Learn more</NavLink>
        </div>
      </div>
